...
post http://localhost:3000/users 201 "firstname=John&lastname=Doe&age=23&password=arrow"
post http://localhost:3000/users 201 "firstname=Janette&lastname=Doe&age=32&password=darkone"
