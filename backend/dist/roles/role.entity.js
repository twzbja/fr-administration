...
__decorate([
    (0, typeorm_1.ManyToOne)(type => user_entity_1.User, user => user.id, { onDelete: 'CASCADE' }),
    (0, typeorm_1.JoinColumn)({ name: "idUser" }),
    __metadata("design:type", Promise)
], Role.prototype, "user", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(type => association_entity_1.Association, association => association.id),
